...
const PhotographyGallery = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-red-50">
      {/* Banner */}
      <div className="relative text-white py-24 sm:py-32 md:py-40 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Title */}
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light mb-4 sm:mb-6 tracking-wide leading-tight">
            {bannerConfig.title}
          </h1>
          {/* Description */}
          <p className="text-base sm:text-lg md:text-lg text-white max-w-2xl font-light leading-relaxed">
