...
const PhotographyGallery = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-red-50">
      ...
      {/* Banner */}
      <section className="relative h-[100vh] sm:h-[90vh] md:h-[80vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center">
          {/* Badge */}
          {bannerConfig.badge && (
            <div className="inline-block mb-3 sm:mb-4 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 rounded-full border border-white/20 backdrop-blur-sm">
          ...
          {/* Title */}
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light mb-4 sm:mb-6 tracking-wide leading-tight text-white">
            {bannerConfig.title}
          </h1>
